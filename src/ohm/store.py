...
class OhmStore:
    ...
    def status(self) -> dict[str, Any]:
        ...
        node_count = self.execute_one("SELECT COUNT(*) AS cnt FROM ohm_nodes")["cnt"]
        edge_count = self.execute_one("SELECT COUNT(*) AS cnt FROM ohm_edges")["cnt"]
        obs_count = self.execute_one("SELECT COUNT(*) AS cnt FROM ohm_observations")["cnt"]
        agent_count = self.execute_one("SELECT COUNT(*) AS cnt FROM ohm_agent_state")["cnt"]
